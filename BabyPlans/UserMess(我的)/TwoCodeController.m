...
@implementation TwoCodeController

- (void)viewDidLoad{

    self.imgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth/2, KScreenWidth/2)];
...

{
    ...
    NSString * str = [NSString stringWithFormat:@"%d",[[defaults valueForKey:@"token"] intValue]];
