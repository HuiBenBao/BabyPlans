...
-(void)createView{
    ...
    bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, KNavBarHeight, KScreenWidth, KScreenHeight-KNavBarHeight)];
//    bgImageView.contentMode=UIViewContentModeTop;
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, 360*SCREEN_WIDTH_RATIO55, KScreenWidth, 40)];
    ...
    _line = [[UIImageView alloc] initWithFrame:CGRectMake((KScreenWidth-280*SCREEN_WIDTH_RATIO55)/2, 90*SCREEN_WIDTH_RATIO55, 280*SCREEN_WIDTH_RATIO55, 2)];
    ...
    //假导航
    UIImageView*navImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, KScreenWidth, 64)];
    navImageView.image=[UIImage imageNamed:@"qrcode_scan_bar.png"];
    navImageView.userInteractionEnabled=YES;
    [self.view addSubview:navImageView];
    UILabel*titleLabel=[[UILabel alloc]initWithFrame:CGRectMake(KScreenWidth/2-32,20 , 64, 44)];
    titleLabel.textColor=[UIColor whiteColor];
    titleLabel.textAlignment = NSTextAlignmentCenter;
    titleLabel.text=@"扫一扫";
    titleLabel.font = FONTBOLD_ADAPTED_WIDTH(62/3);
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
         ...
         _line.frame = CGRectMake((KScreenWidth-280*SCREEN_WIDTH_RATIO55)/2, (90+220)*SCREEN_WIDTH_RATIO55, 280*SCREEN_WIDTH_RATIO55, 2);
    }completion:^(BOOL finished) {
        [UIView animateWithDuration:2 animations:^{
          _line.frame = CGRectMake((KScreenWidth-280*SCREEN_WIDTH_RATIO55)/2, 90*SCREEN_WIDTH_RATIO55, 280*SCREEN_WIDTH_RATIO55, 2);
        }];
