...
- (NSArray *)dataSource{
    ...
    if (!_dataSource) {
        ...
        [CloudLogin UserAttentionWihtPage:[NSString stringWithFormat:@"%d",_page] count:[NSString stringWithFormat:@"%d",DataCount] Success:^(NSDictionary *responseObject) {
            ...
            if (status == 0) {
                ...
                if (ValidArray([responseObject objectForKey:@"friends"])) {
                    
                    NSArray *galleries = [responseObject objectForKey:@"friends"];
